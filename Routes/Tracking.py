...
def trackingSheet(dpt):
    ...
    form.department.data = 'IT'
    form.dept_code.data = '20'
    form.requester.data = f"Dharmik Patel"
    ...
    return render_template("trackingSheet.html", entries=entries, form=form, itemform=ItemForm, date=date)