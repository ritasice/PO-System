...
class POForm(FlaskForm):
    ...
    dept_code = StringField('Dept Code', render_kw={'readonly': True}, validators=[DataRequired()])
    department = StringField('Department', render_kw={'readonly': True}, validators=[DataRequired()])
