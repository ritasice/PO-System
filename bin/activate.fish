...
set -gx VIRTUAL_ENV "/home/PO-System/PO-System"
...
if test -z "$VIRTUAL_ENV_DISABLE_PROMPT"
    ...
    function fish_prompt
        ...
        printf "%s%s%s" (set_color 4B8BBE) "(PO-System) " (set_color normal)
    ...
    set -gx VIRTUAL_ENV_PROMPT "(PO-System) "
end
...
if test -z "$NODE_VIRTUAL_ENV_DISABLE_PROMPT"
    ...
    function fish_prompt
        ...
        if test -n "(PO-System)"
            printf '%s%s ' "(PO-System)" (set_color normal)
        else
